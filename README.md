...
# СТРУКТУРА ПРОЕКТА
**Файл**	                |   **Назначение**/n
uslt.py	                  |   Основной скрипт: загружает модель, обрабатывает данные и выдаёт текст/n
sign_letters_dataset.csv  |	  Датасет с признаками жестов и соответствующими буквами/n
sign_letters_knn.pkl	    |   Обученная модель KNN (pickle-файл) для распознавания жестов/n
README.md	                |   Документация проекта/n
